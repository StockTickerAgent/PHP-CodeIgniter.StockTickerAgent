...
# Generation Time: 2016-04-13 01:18:16 +0000
# ************************************************************
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `avatar`)
VALUES
	(12,'ricky','$2y$10$G2QcaIAC2hIbRl4eAQZcWOKdMn.ys4FCmiPuxYeRz4qwNhO8.bdhq','guest',NULL),
	(14,'jan','$2y$10$KdIEzPVaIrRP1hEszgCEfeP9C07ZMxT2ImxT70YionF5yH1EfQRbC','guest',NULL),
	(15,'anthony','$2y$10$t0vw4x3Ip5XyhwbC5RMwb.pCKofzvlXK33oTnI.P7QWdwd5AqHmsi','admin',NULL),
	(16,'andrew','$2y$10$CpLYIks0A6rLcZK4lhs6BOase.UbKIPkqlmGTWHiqoI6eSvSLQOEa','admin',NULL),
	(17,'donald','$2y$10$2gG2nDf7RNs14pGc0xxg6uN8JadTlGGWQYZ/jqdFU6dWr9YE0fy1W','guest',NULL);
